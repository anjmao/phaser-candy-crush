...
window.onload = () => {
   ...
   function releaseGem(selectedGem) {
      ...
      checkAndKillGemMatches(selectedGem, null);

      if (tempShiftedGem !== null) {
         checkAndKillGemMatches(tempShiftedGem, null);
      }
      ...
      game.time.events.add(dropGemDuration * 100, refillBoard, null); //TODO
      ...
      if (selectedGem && pointer.isDown) {
         ...
         if (checkIfGemCanBeMovedHere(selectedGemStartPos.x, selectedGemStartPos.y, cursorGemPosX, cursorGemPosY)) {
            if (cursorGemPosX !== selectedGem.posX || cursorGemPosY !== selectedGem.posY) {
               ...
               selectedGemTween = tweenGemPos(selectedGem, cursorGemPosX, cursorGemPosY, null); //TODO
               ...
               if (tempShiftedGem !== null) {
                  tweenGemPos(tempShiftedGem, selectedGem.posX, selectedGem.posY, null);
      ...
      if (gem !== null) {
         ...
         if (countVert < MATCH_MIN && countHoriz < MATCH_MIN) {
            if (gem.posX !== selectedGemStartPos.x || gem.posY !== selectedGemStartPos.y) {
               ...
               selectedGemTween = tweenGemPos(gem, selectedGemStartPos.x, selectedGemStartPos.y, null);

               if (tempShiftedGem !== null) {
                  tweenGemPos(tempShiftedGem, gem.posX, gem.posY, null);
               }
